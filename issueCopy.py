...
def main(x):
    ...
    if count==4:
        ...
        newlines2=[]   
        sid=input("\nType the book ID\n")
        g=open("C:/Users/Administrator/Documents/Python Scripts/Library/books.txt")
        while True:
            w=g.readline()
            if(len(w)==0):
                break
        ...
        if flag_1==0:
            inpu_2=input("No book available with this book ID in the library\nPress1.to go back\npress any other key to exit")
            if inpu_2=='1':
                 if (x==1): 
                    os.system('cls')
                    librarian.main1()
        ...
        if flag_1==1:
            ...
            while True:
                ...
                newlines.append(q1)
            f.close()
            g=open('C:/Users/Administrator/Documents/Python Scripts/Library/books.txt',"w")
