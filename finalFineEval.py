...
def main(x):
    ...
    g=open("C:/Users/Administrator/Documents/Python Scripts/Library/list_fin1.txt","w")
    ...
    da1 =input('Enter the final fine evaluation date(dd/mm/yyyy):')
    try:
  ...
  #print d1
    ...
    if s2<s1:
        ...
        main(x)
    os.system('cls')
    f=open("C:/Users/Administrator/Documents/Python Scripts/Library/list_fin1.txt")
